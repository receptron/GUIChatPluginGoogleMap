  ...
  <div class="min-h-screen bg-gray-100 p-4">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div class="bg-white rounded-lg shadow-md flex flex-col h-[600px]">
          <div class="p-3 border-b border-gray-200">
            ...
            <p class="text-xs text-gray-500">
              {{ useMockMode ? "Mock mode - try 'show Tokyo' or 'find ramen'" : "Real API mode" }}
            </p>
          </div>
          ...
          <div class="p-3 border-t border-gray-200">
            <div class="flex gap-2">
              <input
                ...
                type="text"
                placeholder="Type a message... (try 'show Tokyo Station')"
                :disabled="isLoading"
        ...
        <div class="space-y-4">
          <!-- View Component -->
          <div v-if="ViewComponent" class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="p-3 border-b border-gray-200">
...
const executeSample = async (sample: ToolSample) => {
  ...
  messages.value.push({
    role: "tool",
    content: JSON.stringify(toolResult.data || toolResult.message),
    toolCallId,
  });
